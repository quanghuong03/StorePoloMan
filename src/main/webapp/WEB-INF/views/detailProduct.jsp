                ...
                <div class="col-md-6">
                    <div id="product-main-view">
                        <div class="product-view">
                            <img src="${pageContext.servletContext.contextPath}/img/main-product01.jpg" alt="">
                        </div>
                        <div class="product-view">
                            <img src="${pageContext.servletContext.contextPath}/img/main-product02.jpg" alt="">
                        </div>
                        <div class="product-view">
                            <img src="${pageContext.servletContext.contextPath}/img/main-product03.jpg" alt="">
                        </div>
                        <div class="product-view">
                            <img src="${pageContext.servletContext.contextPath}/img/main-product04.jpg" alt="">
                        </div>
                    </div>
                    <div id="product-view">
                        <div class="product-view">
                            <img src="${pageContext.servletContext.contextPath}/img/thumb-product01.jpg" alt="">
                        </div>
                        <div class="product-view">
                            <img src="${pageContext.servletContext.contextPath}/img/thumb-product02.jpg" alt="">
                        </div>
                        <div class="product-view">
                            <img src="${pageContext.servletContext.contextPath}/img/thumb-product03.jpg" alt="">
                        </div>
                        <div class="product-view">
                            <img src="${pageContext.servletContext.contextPath}/img/thumb-product04.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                                            ...
                                            <div class="single-review">
                                                ...
                                                <div class="review-body">
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi
                                                        ut aliquip ex ea commodo consequat.Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                                                </div>
                                            </div>
