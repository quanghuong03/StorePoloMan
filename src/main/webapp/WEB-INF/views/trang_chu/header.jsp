                    ...
                    <li class="header-account dropdown default-dropdown">
                        <div class="dropdown-toggle" role="button" data-toggle="dropdown" aria-expanded="true">
                            ...
                            <c:if test="${not empty khachHang}">
                                <strong class="text-uppercase">${khachHang.tenKhachHang} <i
                        ...
                        <li class="header-cart dropdown default-dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                <div class="header-btns-icon">
                                    ...
                                    <span class="qty">${not empty giohangct ? giohangct.size() : 0}</span>
                                </div>
                            ...
                            <div class="custom-menu">
                                <div id="shopping-cart">
                                    <div class="shopping-cart-list">
                                        <c:choose>
                                            <c:when test="${not empty giohangct}">
                                                <c:forEach items="${giohangct}" var="giohang">
                                                    <div class="product product-widget">
                                                        <div class="product-thumb">
                                                            <img src="${pageContext.servletContext.contextPath}/img/sanpham/${giohang.ctsp.sp.hinhAnh}" alt="">
                                                        </div>
                                                        <div class="product-body">
                                                            <h3 class="product-price">${giohang.ctsp.sp.giaBan} <span class="qty">x${giohang.soLuong}</span></h3>
                                                            <h2 class="product-name"><a href="#">${giohang.ctsp.sp.tenSanPham}</a></h2>
                                                        </div>
                                                        <form method="post" action="${pageContext.servletContext.contextPath}/cart/deleteItem">
                                            ...
                                            <c:otherwise>
                                                <div class="product product-widget">
                                                    <div class="product-body">
                                                        <h2 class="product-name">Giỏ hàng của bạn đang trống</h2>
                                                    </div>
                                                </div>
                                            </c:otherwise>
                                        </c:choose>
                        ...
                        <div class="custom-menu">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="hidden-sm hidden-xs">
                                        <a class="banner banner-1" href="#">
                                            <img src="${pageContext.servletContext.contextPath}//img/banner09.jpg" alt="">
                                            <div class="banner-caption text-center">
